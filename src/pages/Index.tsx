  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-2xl text-center space-y-3 sm:space-y-4">
        ...
        >
          <Sparkles className="shrink-0 mt-1" style={{ color: "var(--gold-shimmer)" }} size={22} />
        ...
        <div className="flex flex-col items-center gap-0.5">
          <div className="flex items-baseline gap-2">
            <span className="text-3xl sm:text-4xl font-extrabold" style={{ color: "var(--gold-shimmer)" }}>3,99€</span>
            <span className="text-sm line-through" style={{ color: "hsl(145 15% 45%)" }}>15,99€</span>
          </div>
          <p className="text-xs flex items-center gap-1" style={{ color: "hsl(145 20% 65%)" }}>
            <AlertTriangle size={12} style={{ color: "var(--gold-shimmer)" }} />
        ...
        <div className="space-y-1.5">
          <a
            ...
            className="w-full max-w-xs mx-auto flex items-center justify-center gap-2 text-sm sm:text-base font-bold py-3 px-6 rounded-xl transition-all duration-300 cursor-pointer active:scale-95 no-underline"
            style={{
          ...
          >
            Quiero el método por 3,99€ <ArrowRight size={18} />
          </a>
          <div className="flex flex-wrap justify-center items-center gap-x-3 gap-y-0.5 text-[11px] font-medium" style={{ color: "hsl(145 25% 70%)" }}>
            <span className="flex items-center gap-1"><Zap size={11} /> Acceso inmediato</span>
            <span className="flex items-center gap-1"><Download size={11} /> PDF descargable</span>
            <span className="flex items-center gap-1"><Lock size={11} /> Hotmart</span>
          </div>
        </div>

        {/* Social proof */}
        <div className="flex flex-wrap justify-center items-center gap-x-4 gap-y-0.5 text-xs font-medium" style={{ color: "hsl(145 22% 75%)" }}>
          <span className="flex items-center gap-1"><Users size={12} style={{ color: "var(--gold-shimmer)" }} /> 1.200+ personas</span>
          <span className="flex items-center gap-1"><Star size={12} style={{ color: "var(--gold-shimmer)" }} fill="currentColor" /> 4,9/5</span>
          <span className="flex items-center gap-1"><TrendingUp size={12} style={{ color: "var(--gold-shimmer)" }} /> Resultados en 7 días</span>
        </div>

        {/* Footer with logo and credits */}
        <div className="pt-3 mt-1 border-t flex flex-col items-center gap-0.5" style={{ borderColor: "hsl(145 20% 25% / 0.4)" }}>
          <img src={amseLogo} alt="AMSE PRO" className="w-14 h-auto rounded-lg" loading="lazy" />
          <p className="text-[11px]" style={{ color: "hsl(145 15% 60%)" }}>
            Creado por Angela Sarmiento, fundadora de Amse Pro
          </p>
          <a href="mailto:hola@amsepro.com" className="text-[11px] font-medium hover:underline flex items-center gap-1" style={{ color: "var(--gold-shimmer)" }}>
            <Mail size={11} /> hola@amsepro.com
          </a>
          <p className="text-[11px] italic" style={{ color: "hsl(145 15% 55%)" }}>
